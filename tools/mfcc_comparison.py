...
(rate, signal) = wav.read("Sounds/vowel-09.wav")
...
def compare_mfcc(vowels):
    ...
    for vowel in vowels:
        ...
        distance = pydistance.MSE(mfcc_averages_target, mfcc_averages)
...
def compare_fbank(vowels):
    ...
    for vowel in vowels:
        ...
        distance = pydistance.MSE(fbank_averages_target, fbank_averages)
...
def compare_logfbank(vowels):
    ...
    for vowel in vowels:
        ...
        distance = pydistance.MSE(logfbank_averages_target, logfbank_averages)
